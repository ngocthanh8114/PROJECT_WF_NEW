...
{
    public partial class OPhucHoiXeMay : UserControl
    {
        public OPhucHoiXeMay()
        {
            InitializeComponent();
        }
        ...
        {
            DataTable dt = xl.LayThongTinDichVu("Phục hồi xe máy");
        ...
        private void OPhucHoiXeMay_Load(object sender, EventArgs e)
        {
